  ...
  return (
    <section className="w-full bg-zinc-50 py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1.5fr] gap-12 lg:gap-24">
                ...
                {mappedServices.map((service) => (
                  ...
                  >
                    <span className={cn(
                      ...
                      activeId === service.slug ? "text-brand" : "text-zinc-400"
                    )}>
                      {service.displayId}
                    </span>
                    <span className={cn(
                ...
                <div className="space-y-8 lg:space-y-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {service.capabilities.map((capability: string) => (
                        <div key={capability} className="flex items-center gap-3 group/item">
                          <div className="w-1.5 h-1.5 rounded-full bg-zinc-300 group-hover/item:bg-brand transition-colors duration-300" />
                  ...
                  <div className="pt-4">
                    <a
                      ...
                      className="inline-flex items-center gap-2 font-mono text-sm uppercase tracking-widest text-zinc-900 hover:text-brand transition-colors group/link"
                    >
                      Learn More
